# Generated by Django 4.1.1 on 2022-09-05 13:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, related_name='mangas', to='parse.category')),
                ('genres', models.ManyToManyField(blank=True, related_name='mangas', to='parse.genre')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manga', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='person_relations', to='parse.manga')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='manga_relations', to='parse.person')),
            ],
        ),
        migrations.AddField(
            model_name='manga',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('manga', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chapters', to='parse.manga')),
            ],
        ),
        migrations.CreateModel(
            name='Author',
