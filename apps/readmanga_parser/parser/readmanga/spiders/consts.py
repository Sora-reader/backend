...
AUTHOR_TAG = '//div[@class = "subject-meta col-sm-7"]/p[@class = "elementList"]/ \
            span[@class = "elem_author "]/a[@class = "person-link"]/text()'
YEAR_TAG = '//div[@class = "subject-meta col-sm-7"]/p[@class = "elementList"]/ \
            span[@class = "elem_year "]/a[@class = "element-link"]/text()'
TRANSLATORS_TAG = '//div[@class = "subject-meta col-sm-7"]/p[@class = "elementList"]/ \
